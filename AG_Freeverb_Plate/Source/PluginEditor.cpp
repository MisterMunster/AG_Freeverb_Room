...
//==============================================================================
AntigravPlateReverbAudioProcessorEditor::AntigravPlateReverbAudioProcessorEditor (AntigravPlateReverbAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    modeButton.setColour(juce::TextButton::buttonOnColourId, juce::Colour(140, 110, 20)); // Gold tone for plate

    // Initial State
    showLate = false;
    modeButton.setToggleState(false, juce::dontSendNotification);
    buttonClicked(&modeButton);

    setSize (800, 500);
}

AntigravPlateReverbAudioProcessorEditor::~AntigravPlateReverbAudioProcessorEditor()
{
    juce::LookAndFeel::setDefaultLookAndFeel(nullptr);
}

void AntigravPlateReverbAudioProcessorEditor::buttonClicked (juce::Button* button)
{
    if (button == &modeButton)
    {
        ...
        modRateKnob.setVisible(true); modRateLbl.setVisible(true);
...
//==============================================================================
void AntigravPlateReverbAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.setColour(juce::Colour(218, 165, 50)); // Gold title
    g.setFont(20.0f);
    g.drawFittedText("Antigrav Plate Reverb", leftPanel.removeFromTop(40), juce::Justification::centred, 1);
}

void AntigravPlateReverbAudioProcessorEditor::resized()
{
